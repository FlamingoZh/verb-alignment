...
def extract_frames(video_file, num_frames=8):
    ...
    try:
        ...
        pass
    #print(os.getcwd())
    #print("extract_frames video_file:",video_file)
    # duration=subprocess.Popen(['ffprobe', '-v', 'error', '-show_entries', 'format = duration', '-of', 'default=noprint_wrappers=1:nokey=1', video_file]).communicate()
